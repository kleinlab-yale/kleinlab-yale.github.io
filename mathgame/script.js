...
const ASSETS = {
  ...
  yardBall: "assets/gpt-yard-ball.png?v=20260702-yard-opacity",
  yardToys: "assets/gpt-yard-toys.png",
  yardBasket: "assets/gpt-yard-basket.png?v=20260702-yard-opacity",
...
function offlineGameAssets() {
  return [
    ...
    "./script.js?v=20260702-yard-opacity",
